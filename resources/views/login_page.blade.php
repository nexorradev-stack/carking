        ...
        <div class="auth-card">
            ...
            <form action="{{route('login_data')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control @error('email') is-invalid @enderror" type="email" name="email" value="{{old('email')}}" required placeholder="conormmc@gmail.com">
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input id="passBox" class="form-control @error('password') is-invalid @enderror" type="password" name="password" required placeholder="••••••••••">
