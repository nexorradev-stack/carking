...
<body>
    <nav class="navbar navbar-expand-lg mt-lg-2 ps-lg-3 pe-lg-3 pt-0">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold d-none d-md-block" href="{{ url('/') }}"><img class="logo img-fluid"
                    src="{{ asset('assets/logowhite.svg') }}" alt=""></a>
            <a class="navbar-brand fw-bold d-lg-none" href="{{ url('/') }}"><img
                    src="{{ asset('assets/logodark.svg') }}"></a>
            ...
            <div>
                ...
                <button id="sidebar-toggle"
                    style="background: none; border: none; color: white; font-size: 30px; cursor: pointer; padding-right: 15px;">
            ...
            <div class="desktop-menu-1 collapse navbar-collapse d-lg-flex gap-lg-4" id="navbarSupportedContent">
                <ul
                    class="mb-2 navbar-nav me-auto mb-lg-0 pe-lg-5 d-lg-flex gap-lg-2 align-items-lg-center justify-content-lg-end w-100">
                    <ul
                        class="mb-2 navbar-nav me-auto mb-lg-0 pe-lg-5 d-lg-flex gap-lg-2 align-items-lg-center justify-content-lg-end w-100">
                    ...
                    <a href="javascript:void(0);" style="min-width: 140px; margin-right: 15px;"
                        class="pt-2 pb-2 text-white btn bg-dark" type="submit" onclick="redirectToPage()">Sell Car</a>
            </div>
        </div>
    </nav>
    <div class="dashboard ">
                        ...
                        <ul class="p-1 nav flex-column">
                            <li class="nav-item d-block d-md-none">
                                <a href="{{ url('/') }}"
                                    ...
                                    data-page="DashboardPage.html" id="dashboard-link">
                                    <img src="{{ asset('assets/icons/dashboard_inactive.svg') }}" class="icon"
                                        id="dashboard-icon" alt="Dashboard">
                                    Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('/dashboard') }}"
                                    ...
                                    data-page="DashboardPage.html" id="dashboard-link">
                                    <img src="{{ asset('assets/icons/analytics-svgrepo-com.svg') }}" class="icon"
                                        id="dashboard-icon" alt="Dashboard">
                                    Dashboard
                                </a>
                            </li>
                            ...
                            <li class="nav-item submit-active-tab">
                                <a href="{{ route('packages.select') }}"
                                    class="nav-link {{ request()->is('packages/select') || request()->is('submitadvert1') || request()->is('submitadvert2') || request()->is('pay/cancel') || request()->is('pay/success') ? 'active' : '' }}"
                                    data-page="advert.html" id="advert-link">
                                    <img src="{{ asset('assets/icons/advert_inactive.svg') }}" class="icon"
                                        id="advert-icon" alt="Advert" style="filter: brightness(0) invert(1);">
                                    Submit Advert
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('my_listing') }}"
                                    class="nav-link {{ Route::is('my_listing') ? 'active' : '' }}"
                                    data-page="listings.html" id="listings-link">
                                    <img src="{{ asset('assets/icons/listings_inactive.svg') }}" class="icon"
                                        id="listings-icon" alt="Listings">
                                    My Listings
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('sold_cars') }}"
                                    class="nav-link {{ Route::is('sold_cars') ? 'active' : '' }}"
                                    data-page="listings.html" id="listings-link">
                                    <img src="{{ asset('assets/icons/material-symbols_car-tag.svg') }}"
                                        class="icon" id="favourite-icon" alt="Favourite">
                                    Sold Cars
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('/advert/showfavorite') }}"
                                    class="nav-link {{ request()->is('advert/showfavorite') ? 'active' : '' }}"
                                    data-page="favourite.html" id="favourite-link">
                                    <img src="{{ asset('assets/icons/favourite_inactive.svg') }}" class="icon"
                                        id="favourite-icon" alt="Favourite">
                                    My Favourite
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('faqs.sellers') }}"
                                    class="nav-link {{ request()->is('faqs-sellers') ? 'active' : '' }}"
                                    data-page="faq.html" id="faq-link">
                                    <img src="{{ asset('assets/icons/faq_inactive.svg') }}" class="icon"
                                        id="faq-icon" alt="FAQ">
                                    FAQs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('/support') }}"
                                    ...
                                    data-page="support.html" id="support-link">
                                    <img src="{{ asset('assets/icons/material-symbols_chat.svg') }}" class="icon"
                                        id="support-icon" alt="support">
                                    Support
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/changepassword') }}"
                                    ...
                                    data-page="password.html" id="password-link">
                                    <img src="{{ asset('assets/icons/password_inactive.svg') }}" class="icon"
                                        id="password-icon" alt="Password">
                                    Change Password
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="@if (Auth::user()->role == 'private_seller') {{ url('/private_seller') }}@else{{ url('/car_dealer') }} @endif"
                                    class="nav-link @if (Auth::user()->role == 'private_seller') {{ request()->is('private_seller') ? 'active' : '' }}@else{{ request()->is('car_dealer') ? 'active' : '' }} @endif"
                                    data-page="profile.html" id="profile-link">
                                    <img src="{{ asset('assets/icons/profile_inactive.svg') }}" class="icon"
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link {{ request()->is('logout') ? 'active' : '' }}"
                                    id="logout-link">
                                    <img src="{{ asset('assets/icons/logout_inactive.svg') }}" class="icon"
                                        id="logout-icon" alt="Logout">
                                    Logout
                                </a>
                            </li>
