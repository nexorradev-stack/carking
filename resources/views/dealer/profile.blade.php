                    ...
                    <div class="card dealer-profile-card" style="">
                        ...
                        <div class="p-4">
                           ...
                           @if (!empty($dealer->website))
                            ...
                            <div class="d-block d-md-none text-center">
                                <a href="mailto:<?php echo $dealer->email; ?>" 
                                class="btn btn-dark" 
                                style="border-radius: 10px; width: 100%; margin-bottom:15px;">
                                    Send Email
                                </a>
            ...
            <div class="modal-content" style="border-radius: 20px; height: auto !important;">
                ...
                <div class="modal-body">
                    <form id="inquiryForm" method="POST" action="/send-inquiry-dealer">
                        ...
                        <input type="hidden" name="dealer_email" value="{{ $dealer->email }}">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <p class="car_varient text-truncate">
                                                   @if (empty($car_data['car']['Trim']) || $car_data['car']['Trim'] == 'N/A')
                                                        {{ strtoupper(e($car_data['car']['variant'] ?? '')) }}
                                                    @else
                                                ...
                                                <div class="car_detail">
                                                    <div class="car_detail_type">
                                                        ...
                                                        <p class="car_detail_type_text">{{ e(isset($car_data['car']['miles']) ? number_format($car_data['miles'], 0, '.', ',') : 'N/A') }}</p>
                                                    </div>
                                                    <div class="car_detail_type">
                                                     
                                                        <p class="car_detail_type_text">{{ e($car_data['car']['fuel_type'] ?? 'N/A') }}</p>
                                                    </div>
                                                    <div class="car_detail_type">
                                                      
                                                        <p class="car_detail_type_text">{{ e($car_data['car']['gear_box'] ?? 'N/A') }}</p>
                                                    </div>
                                                </div>
